...
"""),_display_(Seq[Any](/*6.2*/main("")/*6.10*/{_display_(Seq[Any](format.raw/*6.11*/("""
  ...
  <br/> <br/>
  <h3>View the <a href=""""),_display_(Seq[Any](/*27.26*/routes/*27.32*/.TeacherCourseManagement.list())),format.raw/*27.63*/("""">list</a> of all assigned courses to teachers</h3>
...
""")))})))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /home/shaon/workspace/EIMS/app/views/teachercourse/create.scala.html
                    HASH: 1cd6e6c7034993bb7516f5fb7bb8545bba4b4fe3
